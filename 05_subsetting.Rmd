---
title: "R Code Basics"
subtitle: "Experimental Design and Data Analysis (01-Oct-21)"
...
Above: "YAML header" (flanked by lines with just three dashes ---)
...
df1[c(2,3), c(1,3)]
```
And again, as with vectors, we can also subset with Boolean/logical values:  
